...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($conexion) {
        $query = "SELECT * FROM usuarios INNER JOIN empleados ON usuarios.usuario_id = emplados.usuario_id WHERE empleados.email='$email' AND usuarios.contrasena='$contrasena'";

...
<body>
    <form action="ingresarcliente.php" method="POST">
        ...
        <div>
            Direccion: <input type="text" name="direccion" id="direccion" placeholder="Direccion" required><br>
            <p id="direccionOutput" class="validation-message">La dirección no puede ser vacia.</p>
        </div>
        <div>
        ...
        <button type="submit" id="buttonSubmit">Registrarse</button>
    </form>
</body>
</html>
